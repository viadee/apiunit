...
public class HttpPostMethodsMustHaveRequestBody implements ApiRule {
    ...
    public ApiUnitTestResultObject check(JavaClasses importedClasses) {
        for (JavaClass importedClass : importedClasses) {
            checkMethodsForPostMethodsForRequestBody(importedClass);
        }
    ...
    private void checkMethodsForPostMethodsForRequestBody(JavaClass javaClass) {
        javaClass.getAllMethods().forEach(javaMethod -> {
            if (Utils.isPostMethod(javaMethod)) {
